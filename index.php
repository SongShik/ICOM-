...
<body>
    ...
    <section>
        ...
        <div class="parallax-window imagem-principal  text-center overlay " data-parallax="scroll"
    ...
    <section>
        ...
        <div class="separator"><span class="titulo"> Vantagens da ICOM </span></div>
        <!-- carousel pequeno-->
                    ...
                    <div class="box-externo ">
                        <div class="box ">
                            ...
                            <div class="box-direita texto-cinza  ">
                                ...
                                O Principal foco da ICOM Seguros é reduzir o custo que a empresa tem com plano de saúde
                                empresarial.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-externo ">
                        <div class="box ">
                            ...
                            <div class="box-direita texto-cinza">
                                ...
                                Buscamos sempre estreitar nosso relacionamento com nosso cliente para que ele saiba que
                                poderá sempre
                                contar com a ICOM.
                            </div>
                        </div>
                    ...
                    <div class="box-externo ">
                        <div class="box ">
                            ...
                            <div class="box-direita texto-cinza ">
                                ...
                                A ICOM também oferece um desconto exclusivo na contratação de planos para PME, cote seu
                                plano e veja a
                                diferença!
                            </div>
                        </div>
        ...
        <div class="owl-carousel mt-5 wow fadeIn" data-wow-delay="1s" id="seguradoras-slider" >
            ...
            <div class="item"><img src="img/teste-imagem.png" alt="image" /></div>
            <div class="item"><img src="img/teste-imagem.png" alt="image" /></div>
            <div class="item"><img src="img/teste-imagem.png" alt="image" /></div>
            <div class="item"><img src="img/teste-imagem.png" alt="image" /></div>
            <div class="item"><img src="img/teste-imagem.png" alt="image" /></div>
    ...
    <section class="depoimentos-fundo">
        ...
        <div class="separator "><span class="titulo" id="titulo-depoimentos"> Depoimentos da ICOM </span></div>
        <div class="container ">
            <div class="row mt-5">
                <div class="col-md-12">
    ...
    <section id="quemsomos">
        ...
        <div class="container mt-4">
            <div class="row " >
                <div class="col-lg-6  ">
                    <div class="logo-icon">
                        <img class="img-fluid wow fadeIn" data-wow-duration="2s" src="img/ICOM LOGO.png" alt="Imagem não carregou">
                    </div>
                </div>
                <div class="col-lg-6 text-justify ">
                    <div class="wow fadeIn" data-wow-duration="2s"><p>Somos uma consultoria em seguros B2B especializada na área de benefícios
